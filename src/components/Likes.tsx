...
const Likes = ({ item }: { item: MediaItemWithOwner }) => {
  ...
  return (
    <>
      ...
      <button
        className="mb-1 block w-full rounded-xl bg-teal-200 p-4 text-center text-black transition-all duration-500 ease-in-out hover:bg-purple-900 hover:text-white"
        onClick={handleLike}
      >
